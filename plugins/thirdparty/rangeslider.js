(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
	    ...
	    this.onInit = this.options.onInit;
            ...
            this.onhandle = this.element.getAttribute('onhandle');
	    this.percent = null;
        ...
        Plugin.prototype._handleDown = function (e) {
            var onHandle = ((' ' + e.target.className + ' ').replace(newLineAndTabRegexp, ' ').indexOf(this.options.handleClass) > -1);
            if (!onHandle && this.onhandle) return;
